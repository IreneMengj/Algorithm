...
/*
    ...
    This Double Linked class is being used for the garage. Explore the methods and
    modify if you think they should be different.

    You should be able to provide comprehensive commenting exlaining what is happening
    here.
*/
 ...
 */
      ...
      /*
      if we are taking in an index well we first should make sure that it is within the bounds of the
      linkedList. Now this really isnt a concern if we are only ever going to call this method from above as
